...
In the menu bar, go to Android Studio => Settings => Language & Framework => Android SDK
...
When the installation is complete, open Xcode then go to Code => Settings => Locations.
...
### Install Homebrew (for Android and iOS Apps)
...
### Install Watchman (for Android and iOS Apps)
...
### Install Java JRE and JDK (for Android and iOS Apps)
...
### Install React Native (for Android and iOS Apps)
